...
CoD.fxGlitch1_2 = InheritFrom( LUI.UIElement )
CoD.fxGlitch1_2.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.fxGlitch1_2 )
	self.id = "fxGlitch1_2"
	...
	Image0:setImage( RegisterImage( "uie_t7_effect_glitches_menu2" ) )
	...
	Image00:setZoom( 150 )
	Image00:setImage( RegisterImage( "uie_t7_effect_glitches_menu2blur" ) )
