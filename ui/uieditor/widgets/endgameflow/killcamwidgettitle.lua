...
local PostLoadFunc = function ( self, controller, menu )
	LUI.OverrideFunction_CallOriginalFirst( self, "setState", function ( element, controller )
		...
		if IsSelfInState( self, "VictoryGreen" ) then
			f3_local0 = CoD.GetColorBlindColorForPlayer( controller, "FriendlyBlue", f3_local1 )
		elseif IsSelfInState( self, "DefeatRed" ) then
			f3_local0 = CoD.GetColorBlindColorForPlayer( controller, "EnemyOrange", f3_local1 )
		end
		if f3_local0 ~= nil and f3_local1.setting ~= nil and f3_local1.setting ~= Enum.ColorVisionDeficiencies.CVD_OFF then
			local f3_local2 = {
				self.TopFrame,
				self.CornerFrameLL,
				self.CornerFrameUL,
			...
			for f3_local3 = 1, #f3_local2, 1 do
				f3_local2[f3_local3]:setRGB( f3_local0.r, f3_local0.g, f3_local0.b )
			end
		end
	end )
end
